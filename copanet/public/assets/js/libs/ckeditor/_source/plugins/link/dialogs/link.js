...
CKEDITOR.dialog.add( 'link', function( editor )
{
	...
	// Loads the parameters in a selected alias to the alias dialog fields.
	...
	var parseLink = function( editor, element )
	{
		...
		if ( ( javascriptMatch = href.match( javascriptProtocolRegex ) ) )
		{
			...
			// Protected email alias as function call.
		...
		if ( !retval.type )
		{
			...
			// Protected email alias as encoded string.
	...
	return {
		...
		onShow : function()
		{
			...
			// Fill in all the relevant fields if there's already one alias selected.
		...
		onOk : function()
		{
			...
			// Browser need the "href" fro copy/paste alias to work. (#6641)
			...
			if ( !this._.selectedElement )
			{
				...
				{
					// Short mailto alias text view (#5736).
			...
			{
				// We're only editing an existing alias, so just overwrite the attributes.
		...
		// Inital focus on 'url' field if alias is of type URL.
		onFocus : function()
		{
