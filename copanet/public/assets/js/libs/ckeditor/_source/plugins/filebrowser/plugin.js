...
( function()
{
	 ...
	 * @param {Array}
	 *            elements Array of {@alias CKEDITOR.dialog.definition.content}
	 *            objects.
	 */
 ...
 * If not set, CKEditor will use <code>{@alias CKEDITOR.config.filebrowserBrowseUrl}</code>.
 ...
 * If not set, CKEditor will use <code>{@alias CKEDITOR.config.filebrowserUploadUrl}</code>.
