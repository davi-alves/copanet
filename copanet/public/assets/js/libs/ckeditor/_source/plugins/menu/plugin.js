...
CKEDITOR.plugins.add( 'menu',
{
	beforeInit : function( editor )
	{
		 ...
		 * @param {Array} definitions List of definitions for each menu item as if {@alias CKEDITOR.editor.addMenuItem} is called.
		 */
 ...
 * @type String
 * @default 'clipboard,form,tablecell,tablecellproperties,tablerow,tablecolumn,table,anchor,alias,image,flash,checkbox,radio,textfield,hiddenfield,imagebutton,button,select,textarea'
 * @example
 * config.menu_groups = 'clipboard,table,anchor,alias,image';
 */
