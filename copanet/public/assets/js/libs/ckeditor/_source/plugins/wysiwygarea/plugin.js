					...
					editor.addMode( 'wysiwyg',
						{
							...
							focus : function()
							{
								...
								{
									// AIR needs a while to focus when moving from a alias.
 ...
 * users can always reach the native context menu by holding the <em>Ctrl</em> key when right-clicking if {@alias CKEDITOR.config.browserContextMenuOnCtrl}
