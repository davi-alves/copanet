...
CKEDITOR.plugins.add( 'link',
{
	...
	{
		// Add the alias and unlink buttons.
...
{
	/**
	 *  Get the surrounding alias element of current selection.
	 * @param editor
	 * @example CKEDITOR.plugins.alias.getSelectedLink( editor );
	 * @since 3.2.1
	 * The following selection will all return the alias element.
	 *	 <pre>
	 *  <a href="#">li^nk</a>
	 *  <a href="#">[alias]</a>
	 *  text[<a href="#">alias]</a>
...
CKEDITOR.unlinkCommand.prototype =
{
	...
	exec : function( editor )
	{
		 ...
		 * the <a> was, so again we have to remove the alias ourselves. (See #430)
		 *
