...
CKEDITOR.htmlWriter = CKEDITOR.tools.createClass(
{
	...
	proto :
	{
		...
		/**
		 * Writes a line break. It uses the {@alias #lineBreakChars} property for it.
		 * @example
		 * // Writes "\n" (e.g.).
		 * writer.lineBreak();
		 */
		 ...
		 * {@alias #indentationChars} property, repeating it for the current
		 * indentation steps.
		 * @example
		 * // Writes "\t" (e.g.).
		 * writer.indentation();
		 ...
		 *
		 * By default, all elements available in the {@alias CKEDITOR.dtd.$block),
		 * {@alias CKEDITOR.dtd.$listItem} and {@alias CKEDITOR.dtd.$tableContent}
