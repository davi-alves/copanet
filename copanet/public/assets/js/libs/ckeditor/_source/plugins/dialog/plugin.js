...
(function()
{
	...
	CKEDITOR.dialog.prototype =
	{
		...
		/**
		 * Calls the {@alias CKEDITOR.dialog.definition.uiElement#setup} method of each of the UI elements, with the arguments passed through it.
		...
		/**
		 * Calls the {@alias CKEDITOR.dialog.definition.uiElement#commit} method of each of the UI elements, with the arguments passed through it.
	...
	CKEDITOR.tools.extend( CKEDITOR.dialog,
		 ...
		 */
		{
			 ...
			 * return an object conforming to {@alias CKEDITOR.dialog.definition}.
	...
	(function()
	{
		CKEDITOR.ui.dialog =
		{
			 ...
			 * <ul>
			 * 	<li><strong>id</strong> (Required) The id of the UI element. See {@alias
			 ...
			 * 	refer to {@alias CKEDITOR.ui.dialog.uiElement#registerEvents} and
			 * 	{@alias CKEDITOR.ui.dialog.uiElement#eventProcessors} for more
			 * 	information.</li>
			 * </ul>
			 ...
			 * Array of {@alias CKEDITOR.ui.dialog.uiElement} objects inside this
			 * container.
	...
	CKEDITOR.ui.dialog.uiElement.prototype =
	{
		 ...
		 *  	of {@alias CKEDITOR.ui.dialog.uiElement#getInputElement}).
		 *  </li>
		 * </ol>
		 ...
		 * {@alias CKEDITOR.ui.dialog.uiElement#getInputElement} at UI element
	 ...
	 *		this command.
	 * @example
	 * // Register the "alias" command, which opens the "alias" dialog.
	 * editor.addCommand( 'alias', <b>new CKEDITOR.dialogCommand( 'alias' )</b> );
	 */
