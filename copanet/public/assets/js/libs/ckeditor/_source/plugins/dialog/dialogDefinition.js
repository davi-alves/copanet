 ...
 * {@alias CKEDITOR.dialog.definition.button} objects.
 ...
 * {@alias CKEDITOR.dialog.definition.content} objects. Required.
 ...
 * {@alias CKEDITOR.dialog.definition.uiElement} objects.
...
/**
 * Function to execute whenever the UI element's parent dialog's {@alias CKEDITOR.dialog.definition.setupContent} method is executed.
...
/**
 * Function to execute whenever the UI element's parent dialog's {@alias CKEDITOR.dialog.definition.commitContent} method is executed.
 * It usually takes care of the respective UI element as a standalone element.
 ...
 * <br /><br />Once the dialog is opened, the created element becomes a {@alias CKEDITOR.ui.dialog.hbox} object and can be accessed with {@alias CKEDITOR.dialog#getContentElement}.
 * </div>
...
/**
 * Array of {@alias CKEDITOR.ui.dialog.uiElement} objects inside this container.
 ...
 * <br /><br />Once the dialog is opened, the created element becomes a {@alias CKEDITOR.ui.dialog.vbox} object and can be accessed with {@alias CKEDITOR.dialog#getContentElement}.
 * </div>
...
* 	label and the content element. See also {@alias CKEDITOR.dialog.definition.labeledElement#labelLayout}.
 ...
 * <br /><br />Once the dialog is opened, the created element becomes a {@alias CKEDITOR.ui.dialog.button} object and can be accessed with {@alias CKEDITOR.dialog#getContentElement}.
 * </div>
 * For a complete example of dialog definition, please check {@alias CKEDITOR.dialog.add}.
 ...
 * <br /><br />Once the dialog is opened, the created element becomes a {@alias CKEDITOR.ui.dialog.checkbox} object and can be accessed with {@alias CKEDITOR.dialog#getContentElement}.
 * </div>
 * For a complete example of dialog definition, please check {@alias CKEDITOR.dialog.add}.
 ...
 * <br /><br />Once the dialog is opened, the created element becomes a {@alias CKEDITOR.ui.dialog.file} object and can be accessed with {@alias CKEDITOR.dialog#getContentElement}.
 * </div>
 * For a complete example of dialog definition, please check {@alias CKEDITOR.dialog.add}.
 ...
 * <br /><br />Once the dialog is opened, the created element becomes a {@alias CKEDITOR.ui.dialog.fileButton} object and can be accessed with {@alias CKEDITOR.dialog#getContentElement}.
 * </div>
 * For a complete example of dialog definition, please check {@alias CKEDITOR.dialog.add}.
 ...
 * <br /><br />Once the dialog is opened, the created element becomes a {@alias CKEDITOR.ui.dialog.html} object and can be accessed with {@alias CKEDITOR.dialog#getContentElement}.
 * </div>
 * For a complete example of dialog definition, please check {@alias CKEDITOR.dialog.add}.<br />
 * To access HTML elements use {@alias CKEDITOR.dom.document#getById}
 ...
 * <br /><br />Once the dialog is opened, the created element becomes a {@alias CKEDITOR.ui.dialog.radio} object and can be accessed with {@alias CKEDITOR.dialog#getContentElement}.
 * </div>
 * For a complete example of dialog definition, please check {@alias CKEDITOR.dialog.add}.
 ...
 * <br /><br />Once the dialog is opened, the created element becomes a {@alias CKEDITOR.ui.dialog.select} object and can be accessed with {@alias CKEDITOR.dialog#getContentElement}.
 * </div>
 * For a complete example of dialog definition, please check {@alias CKEDITOR.dialog.add}.
 ...
 * <br /><br />Once the dialog is opened, the created element becomes a {@alias CKEDITOR.ui.dialog.textInput} object and can be accessed with {@alias CKEDITOR.dialog#getContentElement}.
 * </div>
 * For a complete example of dialog definition, please check {@alias CKEDITOR.dialog.add}.
 ...
 * <br /><br />Once the dialog is opened, the created element becomes a {@alias CKEDITOR.ui.dialog.textarea} object and can be accessed with {@alias CKEDITOR.dialog#getContentElement}.
 * </div>
 * For a complete example of dialog definition, please check {@alias CKEDITOR.dialog.add}.
