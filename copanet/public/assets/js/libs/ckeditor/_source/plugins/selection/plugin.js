...
(function()
{
	...
	CKEDITOR.dom.selection.prototype =
	{
		 ...
		 * available:
		 * <ul>
		 *		<li><code>{@alias CKEDITOR.SELECTION_NONE}</code> (1): No selection.</li>
		 *		<li><code>{@alias CKEDITOR.SELECTION_TEXT}</code> (2): A text or a collapsed
		 *			selection is selected.</li>
		 *		<li><code>{@alias CKEDITOR.SELECTION_ELEMENT}</code> (3): An element is
		 *			selected.</li>
		 * </ul>
		 * @function
		 * @returns {Number} One of the following constant values:
		 *		<code>{@alias CKEDITOR.SELECTION_NONE}</code>, <code>{@alias CKEDITOR.SELECTION_TEXT}</code>, or
		 *		<code>{@alias CKEDITOR.SELECTION_ELEMENT}</code>.
		 * @example
		...
		/**
		 * Retrieves the <code>{@alias CKEDITOR.dom.range}</code> instances that represent the current selection.
		...
		/**
		 * Makes the current selection of type <code>{@alias CKEDITOR.SELECTION_ELEMENT}</code> by enclosing the specified element.
		 ...
		 * @param {Array} ranges An array of <code>{@alias CKEDITOR.dom.range}</code> instances representing ranges to be added to the document.
		 * @example
		 ...
		 * by calling the <code>{@alias CKEDITOR.dom.range.prototype.createBookmark}</code> method,
		...
		/**
		 *  Creates a bookmark for each range of this selection (from <code>#getRanges</code>)
		 * by calling the <code>{@alias CKEDITOR.dom.range.prototype.createBookmark2}</code> method,
		 * with extra care taken to avoid interference among those ranges. The arguments
		 * received are the same as with the underlying range method.
		 * @returns {Array} Array of bookmarks for each range.
		 * @example
