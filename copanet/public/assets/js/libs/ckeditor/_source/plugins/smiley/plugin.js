 ...
 * {@alias CKEDITOR.config.smiley_path} setting.
 * @type Array
 * @default (see example)
 * @example
 ...
 * {@alias CKEDITOR.config.smiley_images} setting. Each entry in this array list
 * must match its relative pair in the {@alias CKEDITOR.config.smiley_images}
 * setting.
 * @type Array
