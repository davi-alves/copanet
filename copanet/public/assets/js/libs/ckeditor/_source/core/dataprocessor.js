...
/**
 * @fileOverview Defines the "virtual" {@alias CKEDITOR.dataProcessor} class, which
 *		defines the basic structure of data processor objects to be
 *		set to {@alias CKEDITOR.editor.dataProcessor}.
 */
 ...
 * Generaly it will point to an instance of {@alias CKEDITOR.htmlDataProcessor},
 ...
 * it can handle HTML data only. The roles of the data processor is transforming
