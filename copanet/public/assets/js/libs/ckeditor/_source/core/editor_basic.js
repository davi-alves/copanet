...
if ( !CKEDITOR.editor )
{
	 ...
	 * used, in favor of the {@alias CKEDITOR} editor creation functions.
	 ...
	 *		instance. See {@alias #elementMode}.
	...
	CKEDITOR.editor = function( instanceConfig, element, mode, data )
	{
		...
		/**
		 * The mode in which the {@alias #element} is linked to this editor
		 * instance. It can be any of the following values:
		 * <ul>
		 * <li>{@alias CKEDITOR.ELEMENT_MODE_NONE}: No element is linked to the
		 *		editor instance.</li>
		 * <li>{@alias CKEDITOR.ELEMENT_MODE_REPLACE}: The element is to be
		 *		replaced by the editor instance.</li>
		 * <li>{@alias CKEDITOR.ELEMENT_MODE_APPENDTO}: The editor is to be
	 ...
	 * this function directly. Use {@alias CKEDITOR.replace} instead.
	 ...
	 * this function directly. Use {@alias CKEDITOR.appendTo} instead.
