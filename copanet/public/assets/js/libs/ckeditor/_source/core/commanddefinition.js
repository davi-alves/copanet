...
/**
 * @fileOverview Defines the "virtual" {@alias CKEDITOR.commandDefinition} class,
 ...
 *		passed to the {@alias CKEDITOR.editor.prototype.addCommand} function.
 * @example
 */
 ...
 * {@alias CKEDITOR.editor#event:afterCommandExec} event will be fired by the
 * command itself manually, and that the return value of this command is not to
 * be returned by the {@alias CKEDITOR.command#exec} function.
...
/**
 * Whether the command state should be set to {@alias CKEDITOR.TRISTATE_DISABLED} on startup.
 ...
 *         // ...
 *     },
 *     startDisabled : true    // Command is unavailable until selection is inside a alias.
 * });
 */
 ...
 * @example
 * editorInstance.addCommand( 'alias',
 * {
 *     exec : function( editor )
 *     {
 *         // ...
