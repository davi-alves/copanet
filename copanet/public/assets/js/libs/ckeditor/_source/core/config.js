...
/**
 * @fileOverview Defines the <code>{@alias CKEDITOR.config}</code> object that stores the
 * default configuration settings.
 */

/**
 * Used in conjunction with <code>{@alias CKEDITOR.config.enterMode}</code>
 * and <code>{@alias CKEDITOR.config.shiftEnterMode}</code> configuration
...
CKEDITOR.config =
{
	 ...
	 * the language specified in the <code>{@alias CKEDITOR.config.defaultLanguage}</code>
	...
	/**
	 * The language to be used if the <code>{@alias CKEDITOR.config.language}</code>
	 ...
	 * <ul>
	 *     <li><code>{@alias CKEDITOR.ENTER_P}</code> (1) &ndash; new <code>&lt;p&gt;</code> paragraphs are created;</li>
	 *     <li><code>{@alias CKEDITOR.ENTER_BR}</code> (2) &ndash; lines are broken with <code>&lt;br&gt;</code> elements;</li>
	 *     <li><code>{@alias CKEDITOR.ENTER_DIV}</code> (3) &ndash; new <code>&lt;div&gt;</code> blocks are created.</li>
	 * </ul>
	 * <strong>Note</strong>: It is recommended to use the
	 * <code>{@alias CKEDITOR.ENTER_P}</code> setting because of its semantic value and
	 * correctness. The editor is optimized for this setting.
	 * @type Number
	 * @default <code>{@alias CKEDITOR.ENTER_P}</code>
	 * @example
	 * // Not recommended.
	...
	/**
	 * Force the use of <code>{@alias CKEDITOR.config.enterMode}</code> as line break regardless
	 * of the context. If, for example, <code>{@alias CKEDITOR.config.enterMode}</code> is set
	 * to <code>{@alias CKEDITOR.ENTER_P}</code>, pressing the <em>Enter</em> key inside a
	...
	/**
	 * Similarly to the <code>{@alias CKEDITOR.config.enterMode}</code> setting, it defines the behavior
	 ...
	 * </ul>
	 * @type Number
	 * @default <code>{@alias CKEDITOR.ENTER_BR}</code>
	 * @example
	 ...
	 * <code>{@alias CKEDITOR.config.extraPlugins}</code> and
	 * <code>{@alias CKEDITOR.config.removePlugins}</code> for customization purposes instead.
	 * @type String
	 * @example
	 */
	plugins :
	 ...
	 * <code>{@alias CKEDITOR.config.plugins}</code> setting.
	 * @type String
	 * @example
	 ...
	 * to avoid loading some plugins defined in the <code>{@alias CKEDITOR.config.plugins}</code>
