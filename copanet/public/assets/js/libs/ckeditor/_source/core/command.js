...
CKEDITOR.command = function( editor, commandDefinition )
{
	...
	CKEDITOR.tools.extend( this, commandDefinition,
		...
		/** @lends CKEDITOR.command.prototype */
		{
			 ...
			 * <ul>
			 * <li>{@alias CKEDITOR.TRISTATE_DISABLED}: the command is
			 *		disabled. It's execution will have no effect. Same as
			 *		{@alias disable}.</li>
			 * <li>{@alias CKEDITOR.TRISTATE_ON}: the command is enabled
			 *		and currently active in the editor (for context sensitive commands,
			 *		for example).</li>
			 * <li>{@alias CKEDITOR.TRISTATE_OFF}: the command is enabled
			 *		and currently inactive in the editor (for context sensitive
			 *		commands, for example).</li>
			 * </ul>
			 * Do not set this property directly, using the {@alias #setState}
			 * method instead.
			 * @type Number
			 * @default {@alias CKEDITOR.TRISTATE_OFF}
			 * @example
...
CKEDITOR.command.prototype =
{
	 ...
	 * {@alias CKEDITOR.command.prototype.state}) available before disabling it
	 * is restored.
	 * @example
	 * command.<b>enable()</b>;
	 ...
	 * {@alias CKEDITOR.command.prototype.state}) will be set to
	 * {@alias CKEDITOR.TRISTATE_DISABLED}.
	 * @example
	 * command.<b>disable()</b>;
	 ...
	 * @param {Number} newState The new state. See {@alias #state}.
