...
/**
 * @fileOverview Defines the {@alias CKEDITOR.event} class, which serves as the
...
if ( !CKEDITOR.event )
{
	 ...
	 * the {@alias #.implementOn} function used in class prototypes directly
	 * instead.
	 * @class This is a base class for classes and objects that require event
	 * handling features.<br />
	 * <br />
	 * Do not confuse this class with {@alias CKEDITOR.dom.event} which is
	...
	/**
	 * Implements the {@alias CKEDITOR.event} features in an object.
	...
	CKEDITOR.event.prototype = (function()
	{
		...
		return /** @lends CKEDITOR.event.prototype */ {
			 ...
			 *		event. A single {@alias CKEDITOR.eventInfo} object instanced
			 *		is passed to this function containing all the event data.
			 * @param {Object} [scopeObj] The object used to scope the listener
			 *		call (the this object. If omitted, the current object is used.
			 * @param {Object} [listenerData] Data to be sent as the
			 *		{@alias CKEDITOR.eventInfo#listenerData} when calling the
			 *		listener.
			 ...
			 *		{@alias CKEDITOR.eventInfo#data} when calling the
			 *		listeners.
			 * @param {CKEDITOR.editor} [editor] The editor instance to send as the
			 *		{@alias CKEDITOR.eventInfo#editor} when calling the
			 *		listener.
			 ...
			 * successive calls of it or of {@alias #fire}.
			 * @param {String} eventName The event name to fire.
			 * @param {Object} [data] Data to be sent as the
			 *		{@alias CKEDITOR.eventInfo#data} when calling the
			 *		listeners.
