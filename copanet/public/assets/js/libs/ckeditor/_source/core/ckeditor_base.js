...
/**
 * @fileOverview Contains the first and essential part of the {@alias CKEDITOR}
 *		object definition.
 */
...
if ( !window.CKEDITOR )
{
	...
	window.CKEDITOR = (function()
	{
		...
		/** @lends CKEDITOR */
		{
			 ...
			 * set to the {@alias CKEDITOR.timestamp} value.<br />
			 * <br />
 ...
 * modify the editor instance configuration ({@alias CKEDITOR.editor#config }).
 * It is usually defined inside the custom configuration files that can
 * include developer defined settings.
 * @name CKEDITOR.editorConfig
 * @function
 * @param {CKEDITOR.config} config A configuration object containing the
 *		settings defined for a {@alias CKEDITOR.editor} instance up to this
