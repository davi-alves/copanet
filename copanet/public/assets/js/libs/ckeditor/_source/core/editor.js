...
/**
 * @fileOverview Defines the {@alias CKEDITOR.editor} class, which represents an
 *		editor instance.
 */
...
(function()
{
	...
	var onConfigLoaded = function( editor )
	{
		 ...
		 * be set through the <code>{@alias CKEDITOR.config.skin}</code> setting.
		 ...
		 * instance. This can be set by the <code>{@alias CKEDITOR.config.tabIndex}</code>
		 * setting or taken from the <code>tabindex</code> attribute of the
		 * <code>{@alias #element}</code> associated with the editor.
	...
	CKEDITOR.editor.prototype._init = function()
		{
			 ...
			 * settings defined in <code>(@alias CKEDITOR.config}</code>, combined with settings
...
CKEDITOR.tools.extend( CKEDITOR.editor.prototype,
	/** @lends CKEDITOR.editor.prototype */
	{
		 ...
		 * this function can be executed later with the <code>{@alias #execCommand}</code> method.
		 ...
		 * command definition with <code>{@alias #addCommand}</code>, it is
		 * transformed internally into an instance of
		 * <code>{@alias CKEDITOR.command}</code>, which will then be returned
		 * by this function.
		 ...
		 * combined with the <code>{@alias #loadSnapshot}</code> method in order
		 ...
		 * <code>{@alias #getSnapshot}</code> produced data.
		 ...
		 * some editor features. This function sets the <code>{@alias CKEDITOR.config.readOnly}</code>
		 * property of the editor, firing the <code>{@alias CKEDITOR.editor#readOnly}</code> event.<br><br>
		 ...
		 * <strong>Note:</strong> two subsequent line-breaks will introduce one paragraph. This depends on <code>{@alias CKEDITOR.config.enterMode}</code>;
		 ...
		 * the contents available in the editor when <code>{@alias #resetDirty}</code>
		 * was called.
		 ...
		 * <code>{@alias #checkDirty}</code> will return <code>false</code> if the user will not
 ...
 * <code>{@alias CKEDITOR#instanceReady}</code> event instead.
...
/**
 * Fired before the command execution when <code>{@alias #execCommand}</code> is called.
...
/**
 * Fired after the command execution when <code>{@alias #execCommand}</code> is called.
 ...
 * <code>{@alias CKEDITOR.config.customConfig}</code> setting. Several files can be loaded
 ...
 * <code>{@alias CKEDITOR.editor.prototype.dataReady}</code> event.
...
/**
 * Event fired after the <code>{@alias CKEDITOR.editor#readOnly}</code> property changes.
