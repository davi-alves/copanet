...
/**
 * @fileOverview Defines the "virtual" {@alias CKEDITOR.pluginDefinition} class, which
 ...
 *		passed to the {@alias CKEDITOR.plugins.add} function.
 ...
 * pattern of "langCode.js", and contain a language definition created with {@alias CKEDITOR.pluginDefinition#setLang}.
 * While the plugin is being loaded, the editor checks this list to see if
 * a language file of the current editor language ({@alias CKEDITOR.editor#langCode})
