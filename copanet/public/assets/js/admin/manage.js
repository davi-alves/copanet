...
define(['jquery', 'index', 'holder', 'jquery.migrate', 'fancybox', 'fileupload', 'form', 'jquery.jcrop'], function($, Index, Holder) {
  Index = Index || {};
    ...
    Admin.manage = (function() {
      ...
      getForm = function(target, action) {
        return $.ajax({
          ...
          if ($(__formModal).find(__fileUploadThumbnail).attr('src') === void 0) {
            Holder.run({
