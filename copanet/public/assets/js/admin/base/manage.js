  ...
  Index.Admin = (function(Admin) {
    Admin.manage = (function() {
      ...
      bindEvents = function() {
        ...
        $(__golsButton).live('click', function() {
          event.preventDefault();
          return getForm($(this), 'gols');
        });
